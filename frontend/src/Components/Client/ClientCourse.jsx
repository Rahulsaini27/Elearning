...
const ClientCourse = () => {
  ...
  return (
    <div className="bg-slate-50 min-h-screen py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="mb-10 flex justify-between items-center">
          <h1 className="text-4xl font-extrabold text-slate-800">My Courses</h1>
          <div className="bg-white shadow-md rounded-full px-4 py-2 text-sm text-slate-800">
            Total Courses: {secureUserCourses.length}
          </div>
        </div>
        ...
        {secureUserCourses.length > 0 ? (
              ...
              >
                ...
                <div className="relative bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200">
                  ...
                  <div className="p-6 pt-24 relative z-20">
                    ...
                    <p className={`text-sm text-slate-600 ${expandedDescriptions[course._id] ? '' : 'line-clamp-2'}`}>
                      {course.description}
                    </p>
                    ...
                    <div className="flex items-center justify-between mt-6">
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs font-medium text-slate-600">{course.lessons || 0} Lessons</span>
                      </div>
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs font-medium text-slate-600">{course.videos?.length || 0} Videos</span>
                      </div>
                    </div>

                    {/* Progress Bar */}
                    <div className="w-full bg-slate-200 rounded-full h-1.5 mt-6">
                      <div
          ...
          <div className="bg-white rounded-2xl shadow-sm p-8 text-center max-w-md mx-auto">
            <h3 className="text-xl font-medium text-slate-800 mb-2">No courses yet</h3>
            <p className="text-sm text-slate-600 mb-6">You haven't enrolled in any courses.</p>
          </div>
        )}
      </div>
    </div>
